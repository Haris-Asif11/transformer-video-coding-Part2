...
#following lines added/changed...see original code

class CityscapesDataset(VideoDataset):
    label: Optional[Tensor] = None



VideoData = Union[VideoDataset, KineticsDataset, VimeoDataset, CityscapesDataset]
