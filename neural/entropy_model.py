...
class VCTEntropyModel(nn.Module):
    ...
    def __init__(
        ...
        context_len: int = 2,
        window_size_enc: int = 2,
        window_size_dec: int = 2,
        num_layers_encoder_sep: int = 1,
        num_layers_encoder_joint: int = 1,
        ...
        self.bottleneck = GsnConditionalLocScaleShift(
            num_scales=128, num_means=64, min_scale=0.01, tail_mass=(2 ** (-8))
        )
